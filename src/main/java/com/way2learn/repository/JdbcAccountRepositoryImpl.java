...
public class JdbcAccountRepositoryImpl implements AccountRepository {
	...
	public List<Account> findAllAccounts()  {
		String query="select a.accountNumber,a.name,a.isActive,a.city as city,a.country as country,a.balance ,a.emailaddress from account a  ";
	...
	public void delete(Long accountNumber)  {
		...
		jdbcTemplate.update(query,accountNumber);
